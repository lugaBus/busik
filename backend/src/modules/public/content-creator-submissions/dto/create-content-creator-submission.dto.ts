...
import { I18nDto } from '../../../admin/content-creators/dto/i18n.dto';

export class CreateContentCreatorSubmissionDto {
  @ApiProperty({ 
    type: I18nDto,
  ...
  @ApiPropertyOptional({
    type: Array,
    description: 'Platforms array with platformId, url, and optional description',
    example: [{ platformId: 'platform-id-1', url: 'https://youtube.com/@user', description: { ua: 'Опис' } }]
  })
  @IsOptional()
  @IsArray()
  platforms?: Array<{
